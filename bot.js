...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'bende iyiyim') {
    msg.reply('İyi Olman Beni Mutlu Etti.');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'frenzy nedir') {
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'sa') {
    msg.reply('As Naber Canım <a:galp:755430335553994782> ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'bb') {
    msg.reply('Görüşürüz Bb <a:5614_Rainbow_Diamond:730745747833749555> ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'nasıl kayıt olucam') {
    msg.reply('Dostum Bu Rolü Etiketle! @Kayıt Görevlisi <a:wup:755430328159698954> <a:7027_star_red:730738851517038612>');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'nasıl kayıt olurum') {
    msg.reply('Dostum Bu Rolü Etiketle! @Kayıt Görevlisi <a:wup:755430328159698954> <a:7027_star_red:730738851517038612>');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'beni kayıt edin') {
    msg.reply('Dostum Eğer Kimse Mesajlarına Şuğan Bakmıyorsa Bu Rolü Etiketle! @Kayıt Görevlisi <a:wup:755430328159698954> <a:7027_star_red:730738851517038612>');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'hey siri naber') {
    msg.reply('İyiyim Senden Naber? ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'hey jarvıs naber') {
    msg.reply('İyiyim Senden Naber? ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'hey siri') {
    msg.reply('Lütfen Bir Mesaj Yaz! ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'hey jarvıs') {
    msg.reply('Lütfen Bir Mesaj Yaz! ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'jarvıs nasılsın') {
    msg.reply('Ben İyiyim Sen Nasılsın? <a:7027_star_red:730738851517038612>');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'iyi geceler') {
    msg.reply('Jarvıs İyi Geceler Diler! <a:2266_Rainbow_heart:742734313363079239>');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'hey siri bugün hava nasıl') {
    msg.reply('Sana Yardım Edebilecek Bir Fikrim Var! https://www.google.com/search?q=hava+durumu&rlz=1C1GCEA_enTR906TR906&oq=hava&aqs=chrome.0.69i59j69i57j69i59j35i39j0l3j69i61.1187j0j7&sourceid=chrome&ie=UTF-8');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === '!uptime-davet') {
    msg.reply('https://discord.gg/bGJBJCq <a:galp:755430335553994782> ');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === '!youtube') {
    msg.reply('<a:2266_Rainbow_heart:742734313363079239> Abone Olursan Seviniriz: https://www.youtube.com/channel/UCvViV7BanyGgnQQEzn14qPw?view_as=subscriber <a:2266_Rainbow_heart:742734313363079239>');
  }
});
...
client.on("guildMemberAdd", member => {
  let gelengiden = JSON.parse(
    fs.readFileSync("./ayarlar/gelengiden.json", "utf8")
  );
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setDescription(
      `**${member.user.username}** Sunucumuza Giriş Yaptı! | <a:705086956576571464:730737252639965235>`
    )
...
client.on("guildMemberRemove", member => {
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setThumbnail(member.user.avatarURL || member.user.defaultAvatarURL)
    .setDescription(
      `**${member.user.username}** Sunucumuzdan Çıkış Yaptı! | <a:9855_blob_left:730737314317336726>`
    )
    .addField("Kullanıcı", `${member.user.tag}`)
    .addField("ID", `${member.user.id}`)
    .setTimestamp();
...
client.on("message", async message => {
    ...
    if(sayac[message.guild.id]) {
        if(sayac[message.guild.id].sayi <= message.guild.members.size) {
            const embed = new Discord.RichEmbed()
                .setDescription(`<a:2266_Rainbow_heart:742734313363079239> Tebrikler, Başarılı Bir Şekilde ${sayac[message.guild.id].sayi} Kullanıcıya Ulaştık!`)
                .setColor("0x808080")
                .setTimestamp()
...
client.on("guildMemberRemove", async member => {
 ...
 .setColor("RED")
  ...
  try {
    ...
    giriscikiskanali.send(`<a:2266_Rainbow_heart:742734313363079239> ${member.user.tag}, aramızdan ayrıldı, \**${sayac[member.guild.id].sayi}\** <a:1603_Animated_Cross:730737161078571089> kişi olmamıza \**${sayac[member.guild.id].sayi - member.guild.memberCount}\** kişi kaldı!  <a:5701_dpartnerneon:742734274335342651> `);
...
client.on("guildMemberAdd", async member => {
 ...
 .setColor("GREEN")
  ...
  try {
    let giriscikiskanalID = giriscikis[member.guild.id].kanal;
    let giriscikiskanali = client.guilds.get(member.guild.id).channels.get(giriscikiskanalID);
    giriscikiskanali.send(`<a:2266_Rainbow_heart:742734313363079239> ${member.user.tag}, aramıza katıldı **${sayac[member.guild.id].sayi}** <a:6093_Animated_Checkmark:730742793206759425> kişi olmamıza **${sayac[member.guild.id].sayi - member.guild.memberCount}** kişi kaldı!  <a:5701_dpartnerneon:742734274335342651> ` );
  } catch (e) { // eğer hata olursa bu hatayı öğrenmek için hatayı konsola gönderelim.
    return console.log(e)
  }
    ...
    if (küfür.some(word => msg.content.toLowerCase().includes(word))) {
      try {
        if (!msg.member.hasPermission("MANAGE_WEBHOOKS")) {
          ...
          let embed = new Discord.RichEmbed()
            .setColor(0xffa300)
            .setFooter("Jarvıs Küfür Engelleme Sistemi", client.user.avatarURL)
            .setAuthor(
          ...
          return msg.channel
            .send(
              `${msg.author}, <a:success:730737395774914620> Ben Varken Küfür Edemezsin Sunucu Sahibine Mesajı Gönderdim.`
            )
    ...
    if (reklam.some(word => msg.content.toLowerCase().includes(word))) {
      try {
        if (!msg.member.hasPermission("MANAGE_GUILD")) {
          ...
          msg.guild.owner.user.send(embed);
          return msg.channel
            .send(`${msg.author.tag}, <a:1603_Animated_Cross:730737161078571089> Reklam yapmak yasak bunu bilmiyor musun! <a:1603_Animated_Cross:730737161078571089>`)
            .then(msg => msg.delete(25000));
        }
      } catch (err) {
        console.log(err);
...
const embed1 = new Discord.RichEmbed()
        .setColor("BLUE")
        .setDescription(`${msg.author} <a:699622289376804917:756543975833469028> Küfür Etmemelisin!`)
...
if (!oldMsg.guild) return;
  ...
  if (i == 'aktif') {
      ...
      try {
        ...
        const embed1 = new Discord.RichEmbed()
        .setColor("BLUE")
        .setDescription(`${oldMsg.author} <a:699622289376804917:756543975833469028> Dostum Mesajları Editlemen Sonucu Değiştirmez Küfür Yasak!`)
